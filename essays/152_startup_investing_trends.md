 ...
 **Notes**   
 ...
 <a name=startup_investing_trends_note2>[2]</a> We didn't try to accept a particular number. We have no way of doing that even if we wanted to. We just tried to be significantly pickier.   
